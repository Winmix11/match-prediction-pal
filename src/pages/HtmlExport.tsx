...
import { Download, Copy, ArrowLeft, Check, Code } from 'lucide-react';
...
const HtmlExport = () => {
  ...
  const generateHtmlContent = (matches: any[], teams: any[], stats: any) => {
    return `<!DOCTYPE html>
<html lang="hu">
<head>
    <meta charset="UTF-8">
            ...
            <div className="bg-card rounded-lg p-4 border border-border">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li className="flex items-start gap-2">
                  ...
                  <span>Reszponzív, mobilbarát design</span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="h-5 w-5 bg-primary/20 rounded-full flex items-center justify-center mt-0.5">
                    <Code className="h-3 w-3 text-primary" />
                  </div>
                  <span>Animációk és interaktív elemek</span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="h-5 w-5 bg-primary/20 rounded-full flex items-center justify-center mt-0.5">
                    <Code className="h-3 w-3 text-primary" />
                  </div>
                  <span>Beépített JavaScript funkcionalitás</span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="h-5 w-5 bg-primary/20 rounded-full flex items-center justify-center mt-0.5">
                    <Code className="h-3 w-3 text-primary" />
                  </div>
                  <span>SEO-barát metaadatok</span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="h-5 w-5 bg-primary/20 rounded-full flex items-center justify-center mt-0.5">
                    <Code className="h-3 w-3 text-primary" />
                  </div>
                  <span>Professzionális felhasználói felület</span>
                </li>
              </ul>
            </div>
          </div>
